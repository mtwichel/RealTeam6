...
public class Board {
	...
	public Board(Banker banker) {
		...
		this.propertyGroups = new PropertyGroup[8]; //8 property groups
		init();
	}
	...
	private void populateSpaces() {
		...
		spaces[5] = new Railroad(banker, "Reading Railroad", temp);
		...
		tempReplaceU(150);
		spaces[12] = new Utility(banker, "Electric Company", temp);
		...
		tempReplaceRR(200,25,50,100,200);
		spaces[15] = new Railroad(banker, "Pennsylvania Railroad", temp);
		...
		tempReplaceRR(200,25,50,100,200);
		spaces[25] = new Railroad(banker, "B&O Railroad", temp);
		...
		tempReplaceU(150);
		spaces[28] = new Utility(banker, "Water Works", temp);
		...
		tempReplaceRR(200,25,50,100,200);
		spaces[35] = new Railroad(banker, "Short Line", temp);
